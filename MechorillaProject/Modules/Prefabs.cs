...
namespace SteelMechorilla.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = MechorillaPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = MechorillaPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = MechorillaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = MechorillaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        private static Transform SetupModel(GameObject prefab, Transform modelTransform)
        {
            ...
            aimOrigin.transform.localPosition = new Vector3(0f, 8f, 0f);
        ...
        {
            MechorillaPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            MechorillaPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            MechorillaPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
